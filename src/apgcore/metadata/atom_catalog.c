...
static const apg_atom_contract_field_t field_filter_biquad_lowpass_input[] = {
    FIELD("signal", APG_ATOM_FIELD_SIGNAL),
    FIELD_OPT("cutoff", APG_ATOM_FIELD_SIGNAL_OPTIONAL),
};
static const apg_atom_contract_field_t field_filter_biquad_lowpass_config[] = {
...
static const apg_catalog_contract_t catalog_contracts[] = {
    ...
    {"filter_biquad_lowpass", field_filter_biquad_lowpass_input, FIELD_COUNT(field_filter_biquad_lowpass_input),
     field_signal,        FIELD_COUNT(field_signal), field_filter_biquad_lowpass_config,
     FIELD_COUNT(field_filter_biquad_lowpass_config)                                                                                                                                                                                                  },
