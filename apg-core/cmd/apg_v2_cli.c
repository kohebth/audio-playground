...
static bool compile_wasm_module(const char *source_path, const char *wasm_path) {
    ...
    if (!append_cmd_path(command, sizeof(command), source_root))
        return false;
    if (!append_cmd(command, sizeof(command), "/apg-core/inc -I"))
        return false;
    if (!append_cmd_path(command, sizeof(command), source_root))
        return false;
    if (!append_cmd(command, sizeof(command), "/apg-core/inc/rte -I"))
        return false;
    if (!append_cmd_path(command, sizeof(command), source_root))
        return false;
    ...
    int  written = snprintf(rooted_path, sizeof(rooted_path), "%s/apg-core/src/rte/atom_thunk.c", source_root);
    ...
    static const char *const atom_sources[] = {
        "apg-core/src/atom/amplitude/amplitude_accumulate.c",
        "apg-core/src/atom/amplitude/amplitude_add.c",
        "apg-core/src/atom/amplitude/amplitude_clip_hard.c",
        "apg-core/src/atom/amplitude/amplitude_clip_soft.c",
        "apg-core/src/atom/amplitude/amplitude_divide.c",
        "apg-core/src/atom/amplitude/amplitude_latch.c",
        "apg-core/src/atom/amplitude/amplitude_multiply.c",
        "apg-core/src/atom/amplitude/amplitude_normalize.c",
        "apg-core/src/atom/amplitude/amplitude_smooth.c",
        "apg-core/src/atom/amplitude/amplitude_subtract.c",
        "apg-core/src/atom/delay/delay_fractional.c",
        "apg-core/src/atom/delay/delay_line.c",
        "apg-core/src/atom/delay/delay_tap_feedback.c",
        "apg-core/src/atom/delay/delay_tap_feedforward.c",
        "apg-core/src/atom/delay/delay_unit.c",
        "apg-core/src/atom/detect/detect_autocorrelate.c",
        "apg-core/src/atom/detect/detect_envelope.c",
        "apg-core/src/atom/detect/detect_peak.c",
        "apg-core/src/atom/detect/detect_pitch.c",
        "apg-core/src/atom/detect/detect_rms.c",
        "apg-core/src/atom/detect/detect_slope.c",
        "apg-core/src/atom/detect/detect_threshold.c",
        "apg-core/src/atom/detect/detect_zero_crossing.c",
        "apg-core/src/atom/filter/filter_allpass.c",
        "apg-core/src/atom/filter/filter_biquad.c",
        "apg-core/src/atom/filter/filter_comb_fb.c",
        "apg-core/src/atom/filter/filter_comb_ff.c",
        "apg-core/src/atom/filter/filter_dc_block.c",
        "apg-core/src/atom/filter/filter_differentiate.c",
        "apg-core/src/atom/filter/filter_fir.c",
        "apg-core/src/atom/filter/filter_integrate.c",
        "apg-core/src/atom/frequency/frequency_fft.c",
        "apg-core/src/atom/frequency/frequency_ifft.c",
        "apg-core/src/atom/frequency/frequency_multiply.c",
        "apg-core/src/atom/frequency/frequency_overlap_add.c",
        "apg-core/src/atom/frequency/frequency_overlap_save.c",
        "apg-core/src/atom/frequency/frequency_quantize.c",
        "apg-core/src/atom/frequency/frequency_shift.c",
        "apg-core/src/atom/frequency/frequency_window.c",
        "apg-core/src/atom/generation/generation_dc.c",
        "apg-core/src/atom/generation/generation_envelope.c",
        "apg-core/src/atom/generation/generation_impulse.c",
        "apg-core/src/atom/generation/generation_lfo.c",
        "apg-core/src/atom/generation/generation_noise.c",
        "apg-core/src/atom/generation/generation_oscillator.c",
        "apg-core/src/atom/interpolation/interpolation_cubic.c",
        "apg-core/src/atom/interpolation/interpolation_lagrange.c",
        "apg-core/src/atom/interpolation/interpolation_linear.c",
        "apg-core/src/atom/interpolation/interpolation_sinc.c",
        "apg-core/src/atom/mix/mix_crossfade.c",
        "apg-core/src/atom/mix/mix_decode_ms.c",
        "apg-core/src/atom/mix/mix_encode_ms.c",
        "apg-core/src/atom/mix/mix_matrix.c",
        "apg-core/src/atom/mix/mix_pan_stereo.c",
        "apg-core/src/atom/mix/mix_wet_dry.c",
        "apg-core/src/atom/modulation/modulation_amplitude.c",
        "apg-core/src/atom/modulation/modulation_frequency.c",
        "apg-core/src/atom/modulation/modulation_phase.c",
        "apg-core/src/atom/modulation/modulation_ring.c",
        "apg-core/src/atom/modulation/modulation_scrub.c",
        "apg-core/src/atom/nonlinear/nonlinear_bitcrush.c",
        "apg-core/src/atom/nonlinear/nonlinear_sample_hold.c",
        "apg-core/src/atom/nonlinear/nonlinear_waveshape.c",
        "apg-core/src/atom/source/source_antialias.c",
        "apg-core/src/atom/source/source_antiimage.c",
        "apg-core/src/atom/source/source_convert_format.c",
        "apg-core/src/atom/source/source_downsample.c",
        "apg-core/src/atom/source/source_upsample.c",
    };
