...
- `src/rte/runtime.c` and `inc/rte/runtime.h`: used by `test_unit_load_all`, `test_runtime_process_frames`, `test_offline_chain`, `test_hall_reverb`, `src/live.c`, and `src/test_runtime.c`.
