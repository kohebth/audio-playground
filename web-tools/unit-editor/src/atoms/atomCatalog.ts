...
export const ATOM_CATALOG: AtomDef[] = [
  ...
  { name: 'generation_oscillator', category: 'generation', ins: ['frequency'], outs: ['signal'], config: [{ name: 'frequency', type: 'float' }, { name: 'waveform', type: 'int' }, { name: 'phase_offset', type: 'float' }, { name: 'sample_rate', type: 'float' }] },
  { name: 'generation_lfo', category: 'generation', ins: [], outs: ['signal'], config: [{ name: 'frequency', type: 'float' }, { name: 'waveform', type: 'enum', options: ['sine', 'triangle', 'square', 'sawtooth'] }, { name: 'phase_offset', type: 'float' }, { name: 'sample_rate', type: 'float' }] },
  ...
  { name: 'amplitude_latch', category: 'amplitude', ins: ['signal', 'gate'], outs: ['signal'], config: [{ name: 'threshold', type: 'float' }] },
  ...
  { name: 'filter_comb_fb', category: 'filter', ins: ['signal', 'delay'], outs: ['signal'], config: [{ name: 'delay_samples', type: 'int' }, { name: 'coefficient', type: 'float' }] },
  ...
  // ── detect ───────────────────────────────────────────────────────────────
  { name: 'detect_envelope', category: 'detect', ins: ['signal'], outs: ['envelope'], config: [{ name: 'attack', type: 'float' }, { name: 'release', type: 'float' }, { name: 'sample_rate', type: 'float' }] },
  { name: 'detect_peak', category: 'detect', ins: ['signal'], outs: ['signal'], config: [] },
  { name: 'detect_threshold', category: 'detect', ins: ['signal'], outs: ['gate'], config: [{ name: 'threshold', type: 'float' }] },
  { name: 'detect_autocorrelate', category: 'detect', ins: ['signal'], outs: ['correlation'], config: [{ name: 'max_lag', type: 'int' }] },
  { name: 'detect_pitch', category: 'detect', ins: ['signal'], outs: ['pitch'], config: [{ name: 'max_lag', type: 'int' }, { name: 'sample_rate', type: 'float' }] },
  ...
  { name: 'freq_shift', category: 'freq', ins: ['signal', 'pitch_shift'], outs: ['signal'], config: [{ name: 'size', type: 'int' }] },
  ...
  { name: 'freq_quantize', category: 'freq', ins: ['signal'], outs: ['signal'], config: [] },
  ...
  { name: 'src_antialias', category: 'src', ins: ['signal'], outs: ['signal'], config: [{ name: 'cutoff', type: 'float' }, { name: 'sample_rate', type: 'float' }] },
  { name: 'src_antiimage', category: 'src', ins: ['signal'], outs: ['signal'], config: [{ name: 'cutoff', type: 'float' }, { name: 'sample_rate', type: 'float' }] },
