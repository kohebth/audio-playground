...
file(READ "${SESSION_SOURCE}" SESSION_CONTENT)
set(AUDIO_CONTENT "${RUNTIME_CONTENT}\n${SESSION_CONTENT}")

string(FIND "${AUDIO_CONTENT}" "class ApgEngine" ENGINE_CLASS_START)
if (ENGINE_CLASS_START EQUAL -1)
    message(FATAL_ERROR "Could not isolate ApgEngine")
endif ()
...
if (PROCESS_START EQUAL -1 OR PROCESS_END EQUAL -1 OR PROCESS_END LESS PROCESS_START)
    message(FATAL_ERROR "Could not isolate ApgEngine::process")
endif ()
